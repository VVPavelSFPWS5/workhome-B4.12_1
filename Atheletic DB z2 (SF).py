...
def connect_db():
    """
    Соединение к базе данных, создает таблицы, если их еще нет и возвращает объект сессии 
    """
...
def request_data():
    ...
    """
    print("Ищем атлетов схожих с выбранным пользователем.")
